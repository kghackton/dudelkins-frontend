...
<script>
    ...
    export default {
        ...
        computed:{
            start:{
                get(){
                    return this.$store.getters.MAP_FILTER_STARTTIME
                },
                set(val){
                    ...
                    this.$store.dispatch('MAP_FILTER_TIME_SET', {start: startval, end: endval})
                }
            },
            end:{
                get(){
                    return this.$store.getters.MAP_FILTER_ENDTIME
                },
                set(val){
